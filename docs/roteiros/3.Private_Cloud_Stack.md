...
### Pense na estrutura de rede do seu KIT (Altere os Ips dos exemplos de comandos caso necessário) 
  ...
  * **Dica**: se o erro abaixo ocorrer, faça ajustes nos seguintes arquivos "openrcv3_domain,openrcv3_project,openrc" trocando todas ocorrências de "juju run" por " "juju exec":
