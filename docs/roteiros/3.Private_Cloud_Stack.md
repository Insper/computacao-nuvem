...
Espere até **TODOS** os servicos ficarem com o Status "active", exceto o serviço `ceph-radosgw`, que deve estar bloqueado. Para seguir em frente o seu juju status deveria ter a seguinte aparência:
...
### Pense na estrutura de rede do seu KIT (Altere os Ips dos exemplos de comandos caso necessário) 
  ...
  * Configure a rede externa. Usar uma faixa de alocação entre X.X.7.0 e X.X.8.255.
  ### A partir de agora você criara uma rede interna na sua núvem privada, use os valores dados
