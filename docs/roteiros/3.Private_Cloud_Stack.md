...
<!-- Leia sobre o arquivo openrc e depois disso crie o arquivo com este mesmo nome "openrc"
...
### Configurando o Openstack -> LINK de referencia: [link](https://docs.openstack.org/project-deploy-guide/charm-deployment-guide/latest/configure-openstack.html)

### **Criar arquivo opnerc**
