...
Até o momento usamos o *mass* para orquestrar o *bare metal* e o *juju* para cuidar do *deployment* do openstack. E agora vamos utilizar VMs para distribuir os serviços em todas as máquinas restantes do kit.
...
??? info 
    ...
    ??? Conceito importante:
      ...
      Logo você precisa fazer o bootstrap de um novo controlador no server 1. 
...
Observe novamente o status do Juju e aguarde alguns minutos até que apenas o serviço Glance-Simplestreams não estejam ativos.
...
**Desafio Opcional**: Implantar tudo automaticamente com Ansible.
