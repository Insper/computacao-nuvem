...
!!! Dica
    ...
    Aqui estão 3 maneiras diferentes de contornar ou resolver esse problema, basta utilizar uma delas:
...
!!! exercise
    ...
    [Tarefa 4 - Prairielearn](https://us.prairielearn.com/pl/course_instance/190561/assessment_instance/13114183) 
    ...
    1. De um print das Telas abaixo:
      ...
      5. Em um único print mostre os 5 arquivos (.tf) que foram modificados no seu usuário
