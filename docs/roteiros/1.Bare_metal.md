...
Uma Open vSwitch (OVS) bridge reduz a necessidade de duas interfaces de rede físicas. Tal ponte pode ser baseada em um bond de rede ou em uma interface regular.
...
O nome da ponte será referenciado em outras partes deste guia. Use um nome adequado para ela.
...
Configure todos os quatro nós de nuvem desta maneira para garantir que o OVN Chassis possa ser acomodado por qualquer nó.
