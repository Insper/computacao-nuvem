...
Antes de começar a trabalhar nos servidores temos que configurar o IP do Intel AMT para que o MaaS possa se comunicar com estes mesmo que estejam desligados. Siga os próximos passos para configurar corretamente o IP dos servidores:
  ...
  * altere os endereços do IPv4, gateway e DNS preferencial para que correspondam com a sub-rede criada previamente. No final os valores devem ficar parecidos com os da imagem abaixo:
