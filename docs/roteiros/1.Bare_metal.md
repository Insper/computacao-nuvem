...
Antes de começar a trabalhar nos servidores temos que configurar o IP do Intel AMT para que o MaaS possa se comunicar com estes mesmo que estejam desligados. Siga os próximos passos para configurar corretamente o IP dos 5 servidores **(exeto o MAIN)**
  ...
  * altere os endereços do IPv4, gateway para que correspondam com a sub-rede criada previamente e defina o DNS preferencial como o do Insper: 172.20.129.131. No final os valores devem ficar parecidos com os da imagem abaixo:
