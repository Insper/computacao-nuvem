...
* Antes de começar vá até a aba de conteudo adicional e certifique que terminou o **Laboratório de Cabeamento**, ele é a base de rede para iniciarmos nossos 4 Roteiros.

* A partir de agora você deve fazer os Roteiros no seu próprio tempo, levando em conta que é **sempre** (em **todos** os Roteiros) necessário a finalização do Roteiro anterior para iniciar o próximo Roteiro.

* Consulte a imagem abaixo, no "Diagrama" as setas laranjas representam a "Bridge" que será implantado nos próximos passos.
