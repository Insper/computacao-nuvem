...
!!! exercise 
    ...
    1. 22Mantendo o tunel aberto, rode o comando WGET para acesso a aplicacao Django, porem agora o comando deve apontar para o load-balancer, cole a saída do comando aqui.
...
* Também vamos utilisar um charm previamente modificado do **MYSQL**...Faça o clone do repositório GIT. 
...
!!! exercise
    ...
    1. Entre no Dashboard da aplicacao Wordpress fazendo NAT no roteador.
