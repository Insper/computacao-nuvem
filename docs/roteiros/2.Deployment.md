...
* Rode o comando WGET para acesso a aplicacao Django no server 2 e cole a saída do comando.  
* Rode o comando WGET para acesso a aplicacao Django no server 3 e cole a saída do comando.
