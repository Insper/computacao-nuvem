...
* Mantendo o tunel aberto, rode o comando WGET para acesso a aplicacao Django no server 2 e cole a saída do comando.  
* Mantendo o tunel aberto, rode o comando WGET para acesso a aplicacao Django no server 3 e cole a saída do comando.
